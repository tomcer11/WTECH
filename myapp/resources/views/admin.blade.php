                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-dark">Pridať produkt</button>
                        </div>
                      </div>
                    </div>
                  </div>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <form>
                                                ...
                                                <div class="input-group mb-3">
                                                    <label class="input-group" for="image-1-edit">Obrázok 1:</label>
                                                    <input type="file" class="form-control" id="image-1-edit">
                                                </div>
                                                <div class="input-group mb-3">
                                                    <label class="input-group" for="image-2-edit">Obrázok 2:</label>
                                                    <input type="file" class="form-control" id="image-edit">
                                                </div>
                                                <div class="input-group mb-3">
                                                    <label class="input-group" for="image-3-edit">Obrázok 3:</label>
                                                    <input type="file" class="form-control" id="image-3-edit">
                                                </div>
                                                <div class="input-group mb-3">
                                                    <label class="input-group" for="image-4-edit">Obrázok 4:</label>
                                                    <input type="file" class="form-control" id="image-4-edit">
                                                </div>
                                              </form>
                                            </div>
                                            <div class="modal-footer">
