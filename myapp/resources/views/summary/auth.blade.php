    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center R1">
            ...
            <div class="col-9 col-sm-4 text-center stlpce mx-5">
                ...
                <h5 class="info">{{$order->total_price}}€</h5>
            </div>
        </div>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td class="hodnota">{{$order_spec->name}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">Priezvisko</th>
                                <td class="hodnota"">{{$order_spec->surname}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">E-mail</th>
                                <td class="hodnota"">{{$order_spec->email}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">Tel. číslo</th>
                                <td class="hodnota">{{$order_spec->phone_number}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">Ulica a pop. číslo</th>
                                <td class="hodnota">{{$adress->street}} {{$adress->house_number}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">Mesto</th>
                                <td class="hodnota" style="width: 50%">{{$adress->city}}</td>
                            </tr>
                            <tr>
                                <th class="cast" scope="row">PSČ</th>
                                <td class="hodnota">{{$adress->postcode}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
